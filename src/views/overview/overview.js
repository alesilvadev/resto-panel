      ...
      <Container-fluid id="overview">
        <Row className="sub-menu">
          <Col className="col-12 col-lg-2">
            <h3 className="panel-box-title">Resumen general a partir del 2019</h3>
            <p className="panel-box-description">analíticas generales del negocio.</p>
          </Col>
          <Col className="col-12 col-lg-4 sub-menu-item">
            <a onClick={() => setCurrency("UYU")} className={currency == "UYU" ? "active-tab" : ""}>
              Pesos Uruguayos
            </a>
            {/* <a onClick={() => setCurrency("USD")} className={currency == "USD" ? "active-tab" : ""}>
              Dólares
            </a> */}
          </Col>
        </Row>
